        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-2 border-b border-slate-100">
              <h3 className="font-semibold text-slate-900">{text('notifications.title', 'Notifications')}</h3>
              {unreadCount > 0 && (
                <button
                ...
                >
                  ...
                  {text('notifications.actions.markAllRead', 'Mark all read')}
                </button>
              )}
            </div>
            ...
            <div className="max-h-96 overflow-y-auto">
              {isLoading ? (
                ...
                <div className="text-center py-8 text-slate-500">
                  ...
                  <p>{text('notifications.empty.noNotifications', 'No notifications yet')}</p>
                </div>
              ) : (
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        {!notification.read && (
                          <button
                            ...
                            title={text('notifications.actions.markAsRead', 'Mark as read')}
                          >
                        ...
                        <button
                          ...
                          title={text('notifications.actions.delete', 'Delete notification')}
                        >
                          <X className="w-3 h-3" />
                        </button>
                      </div>
            ...
            {notifications && notifications.length > 0 && (
              <div className="border-t border-slate-100 px-4 py-2">
                ...
                >
                  {text('notifications.actions.viewAll', 'View all notifications')}
                </Link>
              </div>
            )}
          </motion.div>
